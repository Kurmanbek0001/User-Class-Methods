...
# Example usage:
user1 = User(101010, "Kurmanbek", "Abduraimov", "misterkuma0@gmail.com", "100705", "2005-07-10")
user2 = User(202020, "Mahabat", "Abduraimova", "maku@email.com", "8778123", "2006-11-26")
...
UserService.update_user(101010, name="Kurmanbek Updated", email="newemail@example.com")
